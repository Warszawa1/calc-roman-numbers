...
//Change background color of the digit buttons
...
// Switch on light
let count = 0;
const colors = ["#687", "aqua"];
const switchOnLight = () => {
    count++
    document.getElementById("light").style.backgroundColor = colors[count % 2]
}
document.getElementById("on").addEventListener("click", switchOnLight)